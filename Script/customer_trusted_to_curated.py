...
AmazonS3_node1718643943017 = glueContext.write_dynamic_frame.from_options(frame=SQLQuery_node1718646756214, connection_type="s3", format="json", connection_options={"path": "s3://baotcn/customers/curated/", "partitionKeys": []}, transformation_ctx="AmazonS3_node1718643943017")
