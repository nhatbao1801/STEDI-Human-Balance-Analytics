...
AmazonS3_node1718650568908 = glueContext.write_dynamic_frame.from_options(frame=SQLQuery_node1718650226212, connection_type="s3", format="json", connection_options={"path": "s3://baotcn/machine_learning/curated/", "partitionKeys": []}, transformation_ctx="AmazonS3_node1718650568908")
