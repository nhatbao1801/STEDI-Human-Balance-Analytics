...
accelerometer_trusted_node1718642196717 = glueContext.getSink(path="s3://baotcn/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="accelerometer_trusted_node1718642196717")
accelerometer_trusted_node1718642196717.setCatalogInfo(catalogDatabase="baotcn_db",catalogTableName="accelerometer_trusted_catalog")
accelerometer_trusted_node1718642196717.setFormat("json")
accelerometer_trusted_node1718642196717.writeFrame(emails_join_node1718641994642)
job.commit()